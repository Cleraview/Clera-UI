...
// Loaded lazily (only when a non-string icon is actually resolved) so
// importing this module never pulls in react-dom/server's browser-streaming
// internals, which reference Web Messaging/Encoding APIs jsdom doesn't
// implement.
...
/** Where along that edge the legend sits. */
