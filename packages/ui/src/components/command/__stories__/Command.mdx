...
<DocsLayout>
  <div>
    ...
    | `...props` | `ComponentPropsWithoutRef<typeof CommandPrimitive>` | - | All standard HTML div props |
    | `ref` | `ForwardedRef` | - | Forwards ref to the underlying CommandPrimitive component |
    ...
    | `...props` | `ComponentPropsWithoutRef<typeof CommandPrimitive.Input>` | - | All standard input props |
    ...
    |------|------|---------|-------------|
    | `className` | `string` | - | Optional CSS classes |
    | `...props` | `ComponentPropsWithoutRef<typeof CommandPrimitive.List>` | - | All standard HTML div props |
    ...
    | Prop | Type | Default | Description |
    |------|------|---------|-------------|
    | `children` | `ReactNode` | - | Empty state message content |
    | `className` | `string` | - | Optional CSS classes |
    | `...props` | `ComponentPropsWithoutRef<typeof CommandPrimitive.Empty>` | - | All standard HTML div props |
    ...
    | `className` | `string` | - | Optional CSS classes |
    | `...props` | `ComponentPropsWithoutRef<typeof CommandPrimitive.Group>` | - | All standard HTML div props |
    ...
    | `className` | `string` | - | Optional CSS classes |
    | `...props` | `ComponentPropsWithoutRef<typeof CommandPrimitive.Item>` | - | All standard HTML div props |
    ...
    |------|------|---------|-------------|
    | `className` | `string` | - | Optional CSS classes |
    | `...props` | `ComponentPropsWithoutRef<typeof CommandPrimitive.Separator>` | - | All standard HTML div props |
