...
<div className="flex gap-space-4xl">
  <div>
    ...
    <DocInfo 
      importStatement={`import { AsyncComboBox } from "@/components/form/async-combobox"`} 
    ...
    <Canvas>
      ...
      <Canvas.Source>
        <Source className="my-0!" dark code={`
          ...
          import { AsyncComboBox, AsyncComboBoxOption } from "@/components/form/asyn-combobox";
    ...
    <Canvas>
      ...
      <Canvas.Source>
        <Source className="my-0!" dark code={`
          import { AsyncComboBox } from "@/components/form/asyn-combobox";
