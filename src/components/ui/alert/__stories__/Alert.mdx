...
<div className="flex gap-space-4xl">
  <div>
    ...
    <DocInfo importStatement={`import { Alert } from "@/components/ui/alert"`} sourcePath={`components/ui/alert`} />
    ...
    In InsightBoard UI, alerts are flexible and can be adapted to different contexts through their props:
