...
<div className="flex gap-space-4xl">
  <div>
    ...
    <DocInfo 
      importStatement={`import { ComboBox } from "@/components/ui/form/combobox"`} 
      sourcePath={`components/ui/form/combobox`} 
    />
    ...
    <Canvas.Source>
      <Source className="my-0!" dark code={`
        // Use for short lists (e.g., "Sort By")
        <Select 
          label="Sort By" 
          options={[
        ...
        // Use for long lists (e.g., "Country")
        <ComboBox 
          label="Country" 
    ...
    <Canvas.Source>
      <Source className="my-0!" dark code={`
        // This CSS variable is set on the trigger and read by the content
        <Popover.Content
