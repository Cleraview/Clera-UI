  ...
  <div>
    ...
    <Canvas.Source>
      <Source className="my-0!" dark code={`
        ...
        // Use Command for navigation/actions
            ...
            items: [
              {
                ...
                label: 'Save',
                icon: FiSave,
                disabled: !canSave, // Conditionally disable
                onSelect: () => handleSave(),
              },
            ],
          },
    ...
    <Canvas.Source>
      <Source className="my-0!" dark code={`
        <div className="w-full max-w-sm">
          <Command className="rounded-lg border border-default shadow-lg">
            <CommandMenu
              groups={menuGroups}
              placeholder="Filter items..."
            />
