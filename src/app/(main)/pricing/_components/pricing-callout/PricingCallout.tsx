...
const PricingCallout: React.FC = () => {
  ...
  return (
    <SectionShell innerClassName="bg-primary-intense text-inverse rounded-4xl px-space-md p-space-xl lg:p-space-2xl shadow-md">
      <div className="flex flex-col lg:flex-row items-center justify-between gap-space-xl text-center lg:text-left">
        <div className="flex-1">
          <div className="space-y-4">
            <h2 ref={titleRef} className="text-heading-5xl font-semibold!">
              Get started with InsightBoard Teams
            </h2>
            <p ref={descRef} className="text-heading-xl text-inverse/70">
        ...
        <div className="flex-1 flex flex-col lg:justify-end justify-center">
          <blockquote
            ref={quoteRef}
            className="text-inverse/90 mt-space-md text-heading-3xl"
          >
          ...
          <p
            ref={authorRef}
            className="text-inverse/70 font-medium mt-space-sm"
          >
